...
public class AbrirArquivo {
    ...
    private String[][] MatrixGrafo;//crio uma matrix para receber os dados do arquivo grafo ja tratados para ter mais facilidade na comparação
    ...
    public AbrirArquivo(String nomeArquivo) {//faço o construtor ja passando o caminho do arquivo para  
        ...
        this.MatrixGrafo = new String[428][428];//crio minha Matrix 428 por 428
    ...
    public void AbrirArquivoGrafo() throws IOException {
        ...
        for (String S : this.LinhaDoArquivo) {// faco um for para pecorre o ArrayList
            ...
            for (int i = 0; i < VetorString.length; i++) {
                MatrixGrafo[n_line][i] = VetorString[i];//Tranferendo oque esta no arquivo e pacando para matrix 
            }
            n_line++;
    ...
    public String[][] getMatrixArquivo() throws IOException {
         return MatrixGrafo;
    }
